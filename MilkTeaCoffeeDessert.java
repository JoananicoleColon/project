...
public class MilkTeaCoffeeDessert {
    ...
    public MilkTeaCoffeeDessert() {
        ...
        btnAdd.addActionListener(e -> {
            ...
            if (addOns.isEmpty()) addOns = "None";
            else addOns = addOns.substring(0, addOns.length() - 2);
            ...
            cbPearls.setSelected(false);
            cbNata.setSelected(false);
            cbJelly.setSelected(false);
            cbPudding.setSelected(false);
            cbCreamCheese.setSelected(false);
        ...
        btnDelete.addActionListener(e -> {
            ...
            else JOptionPane.showMessageDialog(frame, "Select an order!");
        });
